  ...
  def index(conn, params = %{"code" => code}) do
    case authenticate(conn) do
      nil ->
        ...
        json = Poison.encode!(%{client_id: clientID, client_secret: clientSecret, code: code, redirect_uri: "https://drew-github-dahsboard.ngrok.io/callback"})

        case HTTPoison.post("https://github.com/login/oauth/access_token", json, [{"Content-Type", "application/json"}]) do
